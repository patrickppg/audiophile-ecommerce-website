    ...
    <>
      ...
      {!isAsideHidden && (
        <aside className="aside-audiophile">
          ...
          <picture>
            <source srcSet="/images/shared/mobile/image-best-gear.jpg" media="(max-width: 480px)" />
            <source srcSet="/images/shared/tablet/image-best-gear.jpg" media="(max-width: 920px)" />
